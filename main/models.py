...
class SpecModel(models.Model):
    ...
    spec_name = models.CharField(verbose_name='Специальность', blank=True, max_length=200)
    sokr_spec_name = models.CharField(verbose_name='Сокращенно', blank=True, max_length=200)
...
class GraduateInfoModel(models.Model):
    ...
    foto = models.ImageField(verbose_name='Фото', upload_to='uploads/graduates/foto/', blank=True, default='uploads/default.png')
...
class SocialPartnersModel(models.Model):
    title = models.CharField(verbose_name='Имя партнера', max_length=100, blank=True)
    logo_img = models.ImageField(verbose_name='Логотип партнера', upload_to='uploads/graduate/social_partners')
